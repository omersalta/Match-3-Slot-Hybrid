...
public class GameManager : Singleton<GameManager>
{
    ...
    void Start()
    {
        ...
        _board.Initialize(_slotPrefab, _tilePrefab, _rowCount,_cColumnCount, _boardYOffset);
        _configurator.Initialize(_cColumnCount, _rowCount, _boardYOffset);
    }
